...
export default class CommonConstants {
    /**
     * Chinese food image url.
     */
    static readonly CHINESE_IMAGE_URL: string = 'resources/base/media/ic_chinese.png';
    /**
     * Western food image url.
     */
    static readonly WESTERN_IMAGE_URL: string = 'resources/base/media/ic_western.png';
    /**
     * Japanese food image url.
     */
    static readonly JAPANESE_IMAGE_URL: string = 'resources/base/media/ic_japanese.png';
    /**
     * Fast food image url.
     */
    static readonly FAST_IMAGE_URL: string = 'resources/base/media/ic_fast.png';
    /**
     * Vegetarian food image url.
     */
    static readonly VEGETARIAN_IMAGE_URL: string = 'resources/base/media/ic_vegetarian.png';
    /**
     * Noodles food image url.
     */
    static readonly NOODLES_IMAGE_URL: string = 'resources/base/media/ic_noodles.png';
    /**
     * Transform angle.
     */
     ...
     */
    static readonly ARC_START_ANGLE: number = 45;
    /**
     * Arc text end angle.
     */
    static readonly ARC_END_ANGLE: number = 15;
    /**
     * Text align.
     */
