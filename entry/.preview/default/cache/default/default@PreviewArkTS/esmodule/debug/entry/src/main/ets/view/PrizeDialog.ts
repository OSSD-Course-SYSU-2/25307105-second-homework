...
export default class PrizeDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/PrizeDialog.ets(28:5)", "entry");
            Column.backgroundColor({ "id": 16777233, "type": 10001, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" });
            Column.width(StyleConstants.FULL_PERCENT);
            Column.height({ "id": 16777227, "type": 10002, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.prizeData.imageSrc !== undefined ? this.prizeData.imageSrc : '');
            Image.debugLine("entry/src/main/ets/view/PrizeDialog.ets(29:7)", "entry");
            Image.width({ "id": 16777229, "type": 10002, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" });
            Image.height({ "id": 16777229, "type": 10002, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" });
            Image.margin({
                top: { "id": 16777230, "type": 10002, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" },
                bottom: { "id": 16777228, "type": 10002, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" }
            });
            Image.rotate({
                x: 0,
                y: 0,
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/PrizeDialog.ets(43:7)", "entry");
            Text.fontSize({ "id": 16777226, "type": 10002, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" });
            Text.textAlign(TextAlign.Center);
            Text.margin({ bottom: { "id": 16777231, "type": 10002, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" } });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777254, "type": 10003, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/PrizeDialog.ets(48:7)", "entry");
            Text.fontColor({ "id": 16777235, "type": 10001, params: [], "bundleName": "com.example.canvascomponent", "moduleName": "entry" });
